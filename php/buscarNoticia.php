...
$noticiaBuscar= isset($_POST['noticiaBuscar']) ? $_POST['noticiaBuscar'] : "";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
        ...
        <div id="row-full noticias">
            ...
            <?php
                ...
                $conn = conexion();
                $sql = "SELECT * FROM noticia WHERE noticia.titulo LIKE '%$noticiaBuscar%'";
                ...
                while($mostrar = mysqli_fetch_array($res)){
                    ...
                    <?php
                                    ...
                                    if(!isset($mostrar)){?>
                                        <br> <br><br><br> <h3>No se encontraron resultados</h3>
                                    <?php }
                                    ?>
            </div>
        </div>
